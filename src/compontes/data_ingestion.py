...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        try:
            ...
            #df=pd.read_csv(os.path.join("path of the data with filename.extenstion"))
            
            os.makedirs(os.path.dirname(self.data_ingestion_config.raw_data_path),exist_ok=True)
            df.to_csv(self.data_ingestion_config.raw_data_path,index=False) #Saving the raw data
